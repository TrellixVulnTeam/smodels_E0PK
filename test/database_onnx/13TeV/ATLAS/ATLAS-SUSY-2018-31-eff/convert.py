...
#
info.jsonFiles       = {"simplifiedA.json": ["SRA_L", "SRA_M", "SRA_H"],
                        "simplifiedB.json": ["SRB"],
                        "simplifiedC.json": ["SRC_22", "SRC_24", "SRC_26", "SRC_28"]}

jsonfiles= list ( info.jsonFiles.keys() )
jsonfiles.sort()
 # +++++++ dataset block ++++++++++++++
