...
def main():
    ...
    xseccomputer.add_argument('-X', '--Xsec', action='store_true',
        help="use 'xsec' for NLO MSSM strong production cross sections")
    xseccomputer.add_argument('-cl', '--clean_cache', action='store_true',
        help="Clean 'xsec' cache directory.")
